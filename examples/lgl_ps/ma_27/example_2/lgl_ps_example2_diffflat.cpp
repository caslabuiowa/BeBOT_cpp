...
int main() {
    ...
    //app->Options()->SetNumericValue("ma27_pivtol", 1e-8);//0.99 // 1e-8 // between 0 and 1
    // Ipopt may increase pivtol as high as ma27_pivtolmax to get a more accurate solution to the linear system
    //app->Options()->SetNumericValue("ma27_pivtolmax", 0.99);//0.99 // 0.0001 // between 0 and 1
    ...
    // Ipopt will increase the workspace size by ma27_meminc_factor if required
    //app->Options()->SetNumericValue("ma27_la_init_factor", 5.0); // 5.0
    // If the integer or real workspace is not large enough, Ipopt will increase its size by this factor.
    //app->Options()->SetNumericValue("ma27_meminc_factor", 5.0); // 5.0
...
// vpetrov@lnx-me002:~/dev/optimization/BeBOT_cpp/examples/lgl_ps/ma_27/example_2$ g++ -o lgl_ps_example2_diffflat_v2 ~/dev/optimization/BeBOT_cpp_v2/examples/lgl_ps/ma_27/example_2/lgl_ps_example2_diffflat.cpp ~/dev/optimization/BeBOT_cpp_v2/bebot/lgl_ps.cpp ~/dev/optimization/BeBOT_cpp_v2/bebot/lagrangepoly.cpp -I~/dev/optimization/BeBOT_cpp_v2/include -I./Ipopt/src/ -L./Ipopt/src/.libs -lipopt -ldl -lm -lstdc++
// vpetrov@lnx-me002:~/dev/optimization/BeBOT_cpp/examples/lgl_ps/ma_27/example_2$ ./lgl_ps_example2_diffflat_v2

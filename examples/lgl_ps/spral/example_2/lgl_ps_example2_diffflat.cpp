...
// vpetrov@lnx-me002:~/dev/optimization/BeBOT_cpp_v2/examples/lgl_ps/spral/example_2$ g++ -o lgl_ps_example2_diffflat_v2 ~/dev/optimization/BeBOT_cpp_v2/examples/lgl_ps/spral/example_2/lgl_ps_example2_diffflat.cpp ~/dev/optimization/BeBOT_cpp_v2/bebot/lgl_ps.cpp ~/dev/optimization/BeBOT_cpp_v2/bebot/lagrangepoly.cpp -I~/dev/optimization/BeBOT_cpp_v2/include -I./Ipopt/src/ -L./Ipopt/src/.libs -lipopt -lspral -ldl -lm -lstdc++
// vpetrov@lnx-me002:~/dev/optimization/BeBOT_cpp_v2/examples/lgl_ps/spral/example_2$ export LD_LIBRARY_PATH=/usr/local/lib:$LD_LIBRARY_PATH
// vpetrov@lnx-me002:~/dev/optimization/BeBOT_cpp_v2/examples/lgl_ps/spral/example_2$ export OMP_CANCELLATION=TRUE
// vpetrov@lnx-me002:~/dev/optimization/BeBOT_cpp_v2/examples/lgl_ps/spral/example_2$ ./lgl_ps_example2_diffflat_v2
